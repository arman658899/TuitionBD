...
public class TeacherProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //university
        findViewById(R.id.textview_edit_university).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAlertDialogForUpdate("Update College/University","college","UPDATE",tvUniversity);
            }
        });
        //subject
        findViewById(R.id.textview_edit_subject).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showAlertDialogForUpdate("Update Subject/Department","subject","UPDATE",tvSubject);
            }
        });
        //nid
